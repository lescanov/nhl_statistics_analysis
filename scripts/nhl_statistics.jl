...
# I really think I should move towards removing advanced statistics
# If I could cluster off these "raw stats" and identify distinct
# Player clusters, I can then used these advanced stats in a 
# machine learning classification problem.

# This is fine as a start, but will need to incorporate more data
# from other years to really get this going for machine learning.
